...
\begin{figure}[!h]
    \centering
    \subfloat[Checkin]{\includegraphics[width=0.3\textwidth]{qr/tb_besprechung_checkin}}
    \hfill
    \subfloat[Checkin Gast]{\includegraphics[width=0.3\textwidth]{qr/tb_besprechung_checkin_gast}}
    \hfill
    \subfloat[Checkout]{\includegraphics[width=0.3\textwidth]{qr/tb_besprechung_checkout}}
\end{figure}
