...
\begin{figure}[!h]
    \centering
    \subfloat[Checkin]{\includegraphics[width=0.3\textwidth]{qr/vr4_studio_checkin}}
    \hfill
    \subfloat[Checkin Gast]{\includegraphics[width=0.3\textwidth]{qr/vr4_studio_checkin_gast}}
    \hfill
    \subfloat[Checkout]{\includegraphics[width=0.3\textwidth]{qr/vr4_studio_checkout}}
\end{figure}
